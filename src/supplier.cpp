...
void Supplier::run() {
    ...
    while (this->money > 0 and !stopProgram){
        ...
        } else { // s'il ne peut plus payer son employé, arrête la routine
    ...
    this->stopRoutine = true; // double check si pas changer à cause de money == 0
